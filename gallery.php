...
<head>
  ...
  <title>Galeri & Kegiatan | XI RPL</title>
  <style>
    body {
...
<body>
  ...
  <div class="container">
    <h2 class="section-title">Kegiatan & Momen Kelas XI RPL</h2>

    <div class="gallery">
      <a href="#img1" class="gallery-item">
        <img src="assets/img/kegiatan1.jpg" alt="Kegiatan 1">
        <div class="caption">Pelaksanaan P5</div>
      </a>
      ...
      <a href="#img3" class="gallery-item">
        <img src="assets/img/kegiatan3.webp" alt="Kegiatan 3">
      ...
      <a href="#img5" class="gallery-item">
        <img src="assets/img/kegiatan5.webp" alt="Kegiatan 5">
        <div class="caption">Pelaksaan P5 v2</div>
      </a>
      ...
      <a href="#img8" class="gallery-item">
        <img src="assets/img/kegiatan8.webp" alt="Kegiatan 8">
